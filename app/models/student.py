...
class Student(db.Model):
	...
	college = db.StringPropperty(required=True)
...
def create_student(age, gpa, gender, major, college, homestate):
    new_student = Student(age=int(age), gpa = float(gpa), gender = gender, major = major, college = college, homestate = homestate) # Create new database model!
